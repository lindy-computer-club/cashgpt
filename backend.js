"use strict"
async function airequest(openai_inst, message) {
    ...
    const chatCompletion = await openai_inst.chat.completions.create({
        ...
        messages: [
            ...
            //     "content": "\
            //     I am a Single Dad\n\
            //     I make $34,000 per year\n\
            //     I have one child\n\
            //     I am struggling with my mortgage and loans"
            // },
            // {
            //     "role": "system",
            //     "content": "Please give this user advice to improve their financial situation."
            // }
        ],
    });
